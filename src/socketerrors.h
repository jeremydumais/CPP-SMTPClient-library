...
const int SOCKET_INIT_CLIENT_SEND_EHLO_ERROR = -6;
const int SOCKET_INIT_CLIENT_SEND_EHLO_TIMEOUT = -7;

//Init TLS error codes
const int SOCKET_INIT_CLIENT_SEND_STARTTLS_ERROR = -8;
const int SOCKET_INIT_CLIENT_SEND_STARTTLS_TIMEOUT = -9;